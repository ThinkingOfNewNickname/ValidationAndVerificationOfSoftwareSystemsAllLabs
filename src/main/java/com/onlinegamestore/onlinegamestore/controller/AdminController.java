...
import com.onlinegamestore.onlinegamestore.services.GenreService;
import com.onlinegamestore.onlinegamestore.services.GameService;
...
//			List<Genre> categories = this.GenreService.getGenres();
...
//
//		Genre genre =  this.GenreService.addGenre(category_name);
//		if(genre.getName().equals(category_name)) {
...
//	{
//		Genre genre = this.GenreService.updateGenre(id, categoryname);
...
//		Genre genre = this.GenreService.getGenre(categoryId);
//		Game game = new Game();
//		game.setId(categoryId);
//		game.setName(name);
//		game.setCategory(genre);
//		game.setDescription(description);
//		game.setPrice(price);
//		game.setImage(productImage);
