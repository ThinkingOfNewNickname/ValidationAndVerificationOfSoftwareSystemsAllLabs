			...
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<input type="number" readonly="readonly" class="form-control border border-warning" name="id"  value="${game.id + 1} ">
				...
				<div class="form-group">
						...
						<textarea class="form-control border border-warning" rows="4" name="description" placeholder="Product Details" value= "no game details"></textarea>
					</div>
					<p>Product Image</p>
					<div class="form-group">
