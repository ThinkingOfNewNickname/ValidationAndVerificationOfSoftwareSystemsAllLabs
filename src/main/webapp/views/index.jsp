...
<%--        .card-img-top {--%>
<%--          max-height: 100px; /* Limit the height of the game image */--%>
<%--          object-fit: contain;--%>
<%--        }--%>
...
<%--        <div class="col-md-3">--%>
<%--          <div class="card mb-4">--%>
<%--            <img class="card-img-top" src="${game.image}" alt="Product 1">--%>
<%--            <div class="card-body">--%>
<%--             <b> <h4 class="card-title">${game.name}</h4></b>--%>
<%--              <h5 class="card-text">Category: ${game.genre.name}</h5>--%>
<%--              <h5 class="card-text">Price: ${game.price}</h5>--%>
